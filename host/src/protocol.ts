...
export const notebookQueryResultSchema = z.object({
  ...
  path: pathSchema.nullable(), metadata: protocolJsonRecordSchema, config: protocolJsonRecordSchema, dirty: z.boolean(),
